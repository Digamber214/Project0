										...
										<c:forEach items="${list}" var="timetable" varStatus="ct">
											<tr>
												...
												<td class="text-center"><c:url var="editUrl"
														value="/ctl/Timetable/Timetable?id=" /> <a
...
/* background-image: url("http://localhost:8080/orsproject0/resources/img/img12.jpg") */
}
					...
					<c:if test="${!empty list}">
						<div class="row p-2 d-flex justify-content-center">
							<div class="col-lg-3">
								...
								<sf:select path="examTime"
									class="form-control border-left-right">
									<sf:option value="0">
										<s:message code="label.selecttime" />
									</sf:option>
